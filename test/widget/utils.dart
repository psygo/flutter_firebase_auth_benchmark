...
T extractElementByType<T extends Element>(WidgetTester tester, Type type) =>
...
Stless extractStatelessWidgetFromElement<Stless extends StatelessWidget,
...
StatelessWidget extractStatelessWidget(WidgetTester tester, Type type) {
